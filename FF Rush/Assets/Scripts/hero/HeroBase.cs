...
public class HeroBase
{
    ...
    protected HeroBaseState _state;  //当前状态对象
    ...
    public virtual void ActiveHero() { }
    ...
    public void ChangeState(string value, object data = null)
    {
        ...
        {
            this._state = (HeroBaseState)this._stateMap[this._stateName];
        }
        else
        {
            this._state = (HeroBaseState)Activator.CreateInstance(Type.GetType(this._stateName), true);//根据类型创建实例
            this._state.hero = this;
